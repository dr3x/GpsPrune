...
public abstract class ExternalTools
{
	...
	public static final int TOOL_GPSBABEL = 0;
	/** Constant for Gnuplot */
	public static final int TOOL_GNUPLOT  = 1;
	/** Config keys in order that the tools are defined above */
	private static final String[] CONFIG_KEYS = {Config.KEY_GPSBABEL_PATH, Config.KEY_GNUPLOT_PATH};
