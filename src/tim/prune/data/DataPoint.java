...
public class DataPoint
{
	 ...
	 */
	public DataPoint(String[] inValueArray, FieldList inFieldList, Altitude.Format inAltFormat, Color color)
	{
		// save data
	...
	public DataPoint clonePoint()
	{
		...
		DataPoint point = new DataPoint(valuesCopy, _fieldList, _altitude.getFormat(), _color);
		return point;
	}
