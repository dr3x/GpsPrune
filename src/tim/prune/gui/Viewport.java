...
public class Viewport
{
	...
	public double[] getCenterLatLon() {
		...
		int height = _mapCanvas.getHeight();
		MapPosition mapPosition = _mapCanvas.getMapPosition();
		double lat = MapUtils.getLatitudeFromY(mapPosition.getYFromPixels(height/2, height));
		double lon = MapUtils.getLongitudeFromX(mapPosition.getXFromPixels(width/2, width));
