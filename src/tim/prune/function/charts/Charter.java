...
public class Charter extends GenericFunction
{
	...
	public void begin()
	{
		...
		{
			_pruneApp.showErrorMessage(getNameKey(), "dialog.charts.gnuplotnotfound");
			return;
		}
		// Make dialog window
		if (_dialog == null)
		...
		if (setupDialog(_pruneApp.getTrackInfo().getTrack())) {
			_dialog.setVisible(true);
		}
		else {
			_pruneApp.showErrorMessage(getNameKey(), "dialog.charts.needaltitudeortimes");
		}
	}
	...
	private JPanel makeDialogComponents()
	{
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				showChart(_pruneApp.getTrackInfo().getTrack());
